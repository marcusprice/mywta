    ...
    <Card bg="light" style={{ width: '18rem' }}>
      ...
      <Card.Body>
        ...
        <ButtonGroup variant="outline-secondary" type="checkbox">
          <Button variant="outline-secondary" value={1} onClick={() => {props.setReportIndex(props.index); props.setView('view report')}}>View</Button>
          <Button variant="outline-secondary" value={2} onClick={() => {props.setReportIndex(props.index); props.setView('edit report')}}>Edit</Button>
